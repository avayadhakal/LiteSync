...
* **UI Paradigms**: Single-page application (SPA). Client-side i18n. Independent transfer cards (1 per source). Real-time byte upload progress card. Contextual modals for file mutation. Toast notifications. SQLite persistent activity log.
